...
var	Compiler = util.inherit(Object, {
        ...
        compile: function (pathname, data) {
            ...
            if(file.meta.dependencies){
                file.meta.dependencies = util.unique(file.meta.dependencies);
            }
            if(file.meta.packages){
                file.meta.packages = util.unique(file.meta.packages);
            }
        ...
        mount: function (extname, pipeline) {
            ...
            pipeline = pipeline.map(function (name) {
                if(util.isFunction(name)){
                    ...
                    try {
                        return require('./pipe/' + name)(options);
                    } catch (e){
                        return function () {
